...
pf_my_units = {"worker": {}, "knight": {}}#, "ranger": {}, "mage": {}, "healer": {}}

pf_enemy_units = {"worker": {}, "knight": {}}#, "ranger": {}, "mage": {}, "healer": {}}
...
def set_params(chromosome):
    ...
    ww_c, ww_e, ww_k, wr_c, wr_e, wr_k, wf_c, wf_e, wf_k, wro_c, wro_e, wro_k, rw_c, rw_e, rw_k, rr_c, rr_e, rr_k, rf_c, rf_e, rf_k, rro_c, rro_e, rro_k, wew_c, wew_e, wew_k, wek_c, wek_e, wek_k, wer_c, wer_e, wer_k, wem_c, wem_e, wem_k, weh_c, weh_e, weh_k, wef_c, wef_e, wef_k, wero_c, wero_e, wero_k, rew_c, rew_e, rew_k, rek_c, rek_e, rek_k, rer_c, rer_e, rer_k, rem_c, rem_e, rem_k, reh_c, reh_e, reh_k, ref_c, ref_e, ref_k, rero_c, rero_e, rero_k = chromosome#66 values
    ...
    #pf_my_units["worker"]["knight"] = (wk_c, wk_e, wk_k)
    ...
    '''pf_my_units["knight"]["worker"] = (kw_c, kw_e, kw_k)
    pf_my_units["knight"]["knight"] = (kk_c, kk_e, kk_k)
    pf_my_units["knight"]["ranger"] = (kr_c, kr_e, kr_k)
    pf_my_units["knight"]["mage"] = (km_c, km_e, km_k)
    pf_my_units["knight"]["healer"] = (kh_c, kh_e, kh_k)
    pf_my_units["knight"]["factory"] = (kf_c, kf_e, kf_k)
    pf_my_units["knight"]["rocket"] = (kro_c, kro_e, kro_k)'''
    ...
    '''pf_enemy_units["knight"]["worker"] = (kew_c, kew_e, kew_k)
    pf_enemy_units["knight"]["knight"] = (kek_c, kek_e, kek_k)
    ...
    pf_enemy_units["knight"]["factory"] = (kef_c, kef_e, kef_k)
    pf_enemy_units["knight"]["rocket"] = (kero_c, kero_e, kero_k)'''
